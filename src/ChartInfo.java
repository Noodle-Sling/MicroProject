...
public class ChartInfo extends JPanel {
	...
	public ChartInfo(int MaxMRP,double MaxMPP,double MaxProfit) {
		...
		gbc_lblTheFirmsExpected.gridx = 0;
		gbc_lblTheFirmsExpected.gridy = 1;
		...
		gbc_lblTheFirmsExpected_1.insets = new Insets(0, 0, 0, 5);
		gbc_lblTheFirmsExpected_1.anchor = GridBagConstraints.EAST;
		gbc_lblTheFirmsExpected_1.gridx = 0;
		gbc_lblTheFirmsExpected_1.gridy = 2;
